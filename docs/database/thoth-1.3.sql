...
--
-- Host: 127.0.0.1
-- Generation Time: 12-Fev-2019 às 05:12
...
--
-- Extraindo dados da tabela `database`
--

INSERT INTO `database` (`id_database`, `name`) VALUES
(1, 'GOOGLE'),
(2, 'IEEE'),
(3, 'SCOPUS'),
(4, 'SCIENCE DIRECT'),
...
--
ALTER TABLE `activity_log`
  MODIFY `id_activity_log` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=37;
...
--
ALTER TABLE `synonym`
  MODIFY `id_synonym` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

--
-- AUTO_INCREMENT for table `term`
--
ALTER TABLE `term`
  MODIFY `id_term` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
...
ALTER TABLE `project_databases`
  ...
  ADD CONSTRAINT `project_databases_ibfk_2` FOREIGN KEY (`id_database`) REFERENCES `database` (`id_database`);
