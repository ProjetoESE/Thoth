...
CREATE TABLE `thoth`.`status_selection` ( `id_status` INT NOT NULL AUTO_INCREMENT , `description` VARCHAR(255) NOT NULL , PRIMARY KEY (`id_status`)) ENGINE = InnoDB;
CREATE TABLE `thoth`.`status_extraction` ( `id_status` INT NOT NULL AUTO_INCREMENT , `description` VARCHAR(255) NOT NULL , PRIMARY KEY (`id_status`)) ENGINE = InnoDB;
