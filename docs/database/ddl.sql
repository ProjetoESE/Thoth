...
CREATE TABLE IF NOT EXISTS `thoth`.`Paper_Inclusion_Criteria` (
  ...
  INDEX `fk_Paper_Inclusion_Criteria_User1_idx` (`user` ASC) ,
  ...
  CONSTRAINT `fk_Paper_has_Inclusion_Criteria_Inclusion_Criteria1`
    ...
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_Paper_Inclusion_Criteria_User1`
    FOREIGN KEY (`user`)
    REFERENCES `thoth`.`User` (`id_user`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
...
CREATE TABLE IF NOT EXISTS `thoth`.`Paper_Exclusion_Criteria` (
  ...
  INDEX `fk_Paper_Exclusion_Criteria_User1_idx` (`user` ASC) ,
  ...
  CONSTRAINT `fk_Paper_has_Exclusion_Criteria_Exclusion_Criteria1`
    ...
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_Paper_Exclusion_Criteria_User1`
    FOREIGN KEY (`user`)
    REFERENCES `thoth`.`User` (`id_user`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
...
CREATE TABLE IF NOT EXISTS `thoth`.`Paper_Question_Quality` (
  ...
  INDEX `fk_Paper_Question_Quality_User1_idx` (`user` ASC) ,
  ...
  CONSTRAINT `fk_Paper_Question_Quality_Score_Rule1`
    ...
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_Paper_Question_Quality_User1`
    FOREIGN KEY (`user`)
    REFERENCES `thoth`.`User` (`id_user`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
...
-- -----------------------------------------------------
-- Table `thoth`.`Paper_User`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `thoth`.`Paper_User` (
  `id_paper_user` INT NOT NULL AUTO_INCREMENT,
  `paper` INT NOT NULL,
  `user` INT NOT NULL,
  `score` FLOAT NULL,
  ...
  `status_selection` INT NULL,
  `project` INT NOT NULL,
  INDEX `fk_Paper_has_User_User1_idx` (`user` ASC) ,
  INDEX `fk_Paper_has_User_Paper1_idx` (`paper` ASC) ,
  PRIMARY KEY (`id_paper_user`),
  INDEX `fk_Paper_User_Quality_Score1_idx` (`quality_score` ASC) ,
  INDEX `fk_Paper_User_Status_Selection1_idx` (`status_selection` ASC) ,
  INDEX `fk_Paper_User_Project1_idx` (`project` ASC) ,
  ...
  CONSTRAINT `fk_Paper_has_User_User1`
    ...
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_Paper_User_Quality_Score1`
    FOREIGN KEY (`quality_score`)
    REFERENCES `thoth`.`Quality_Score` (`id_quality_score`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_Paper_User_Status_Selection1`
    FOREIGN KEY (`status_selection`)
    REFERENCES `thoth`.`Status_Selection` (`id_status_selection`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_Paper_User_Project1`
    FOREIGN KEY (`project`)
    REFERENCES `thoth`.`Project` (`id_project`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
