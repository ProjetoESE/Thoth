...
--
-- Host: 127.0.0.1
-- Generation Time: 08-Fev-2019 às 13:22
...
(2, 1, 'Guilherme Bolfe created the project Project 06', '2019-02-08 12:05:14', 1),
(3, 1, 'Guilherme Bolfe added the language Russian', '2019-02-08 12:19:00', 1),
(4, 1, 'Guilherme Bolfe logged in', '2019-02-08 12:20:56', 2),
(5, 1, 'Guilherme Bolfe logged out', '2019-02-08 12:21:03', 2);
...
--
ALTER TABLE `activity_log`
  MODIFY `id_activity_log` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
...
--
ALTER TABLE `project_languages`
  MODIFY `id_project_lang` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
