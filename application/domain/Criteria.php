...
/*
* Class to represent the generalization the Criteria object;
*/
abstract class Criteria {
  ...
  private $pre_selected;
	...
	/**
	 * Criteria constructor for data in the database and new registry.
	 * @param String $id
	 * @param String $description
	 * @param boolean $pre_selected
	 */
	public function __construct($id, $description, $pre_selected){
		$this->id = $id;
