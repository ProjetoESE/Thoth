...
class Project_Controller extends CI_Controller
{
	...
	public function add_criteria()
	{
		try {
			...
			$activity = $this->session->name . " added inclusion criteria " . $id;
			$this->insert_log($activity, 1);
	...
	public function selected_pre_select()
	{
		try {
			...
			if ($pre_selected) {
				$activity = $this->session->name . " selected criteria " . $id;
				$this->insert_log($activity, 1);
			} else {
	...
	public function delete_criteria()
	{
		try {
			...
			$activity = $this->session->name . " deleted criteria " . $id;
			$this->insert_log($activity, 1);
	...
	public function edit_criteria()
	{
		try {
			...
			$activity = $this->session->name . " updated criteria " . $new_id;
			$this->insert_log($activity, 1);
