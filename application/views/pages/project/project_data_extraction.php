<div class="card">
	...
	<div class="card-body">
		...
		<ul class="nav nav-pills nav-justified">
			...
			<li class="nav-item">
				<a class="nav-link"  href="<?= base_url('project_controller/quality_assessement/1')?>">Quality Assessement</a>
			</li>
			<li class="nav-item">
				<a class=" nav-link active"  href="<?= base_url('project_controller/data_extraction/1')?>">Data Extraction</a>
			</li>
		</ul>
		<br>
